...
@endif
                ...
                <td>
                    <span class="badge badge-primary">{{number_format($user->questions_corrects / $user->questions_times * 100, 4)}} %</span>
                </td>
            </tr>
        @endforeach
...
@endif
                ...
                <td>
                    <span class="badge badge-primary">{{number_format($me->questions_corrects / $me->questions_times * 100, 4) }} %</span>
                </td>
            </tr>
        @endif
